/*
  ...
  - You are about to drop the `landlords` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "landlords" DROP CONSTRAINT "landlords_admin_id_fkey";
...
-- CreateTable
CREATE TABLE "_TenantToUnits" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_TenantToUnits_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_TenantToUnits_B_index" ON "_TenantToUnits"("B");
...
-- AddForeignKey
ALTER TABLE "_TenantToUnits" ADD CONSTRAINT "_TenantToUnits_A_fkey" FOREIGN KEY ("A") REFERENCES "Unit"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_TenantToUnits" ADD CONSTRAINT "_TenantToUnits_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
